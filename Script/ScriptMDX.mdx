...
SELECT
  ...
  ([Dim Date].[Quarter], [Location].[State Name]) ON ROWS
FROM [DDSDB];
...
SELECT
  ...
  ([Dim Date].[Year], [Quarter], [Location].[State Name]) ON ROWS
FROM [DDSDB];
...
SELECT
  ...
  CROSSJOIN(
    ...
    CROSSJOIN(
      ...
      [Location].[County Name].[County Name]
    )
  ) ON ROWS
FROM [DDSDB];
...
SELECT
  ...
  CROSSJOIN([Dim Category].[Category Name], [Location].[County Name]) ON ROWS
FROM [DDSDB]
WHERE
  {
    [Location].[State Name].&[Hawaii],
    [Location].[State Name].&[Alaska],
    [Location].[State Name].&[Illinois],
    [Location].[State Name].&[Delaware]
  };
...
WHERE
  {
    ...
    [Location].[State Name].&[Alaska],
    [Location].[State Name].&[Illinois],
    [Location].[State Name].&[California]
  };
...
/*SELECT
  [Measures].[Mean Aqi] ON COLUMNS,
  [Location].[State Name].[State Name] ON ROWS
FROM [DDSDB];*/
...
SELECT
  ...
  CROSSJOIN([Dim Date].[Year], [Quarter], CROSSJOIN([Location].[State Name], [Location].[County Name])) ON ROWS
FROM [DDSDB];
...
SELECT
  [Measures].[Mean Aqi] ON COLUMNS,
  CROSSJOIN([Location].[State Name].[State Name], CROSSJOIN([Dim Category].[Aqi Color].[Aqi Color], [Dim Date].[DayLightSaving].[DayLightSaving])) ON ROWS
FROM [DDSDB]*/
...
SELECT
  [Measures].[Count Day] ON COLUMNS,
  CROSSJOIN([Dim Date].[Month], CROSSJOIN([Location].[State Name], [Dim Category].[Category Name])) ON ROWS
FROM [DDSDB];
